...
namespace com\evemyadmin\pages\mail\read\views;

use com\evemyadmin\pages\mail\CommonMailView;
 ...
 * Class Success
 *
 * @package com.evemyadmin.pages\Mail\Read\Views
 */
...
<?php $commonView = new CommonMailView(); $commonView->showHtmlTemplate(); ?>
...
<?php
	...
	public function getJsonTemplate() {
		return array(
				"lists" => $this->mailsLists,
				"labels" => $this->mailLabels,
				"body" => $this->mailBody,
				"is_own" => $this->isOwnCharacter
		);
	}
