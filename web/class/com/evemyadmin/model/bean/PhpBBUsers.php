...
namespace com\evemyadmin\model\bean;

use net\bourelly\core\model\expression\where\Equal;
use net\bourelly\core\model\expression\where\In;
use net\bourelly\core\model\Model;
